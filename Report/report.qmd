...
To help understand what we are referring to when we say "Cluster 1 swing" vs a "Cluster 3 swing",
below are videos of Jose Altuve, two swings from Cluster 1 and two swings from Cluster 3.

::: {.panel-tabset}

## Cluster 1 Swing Example 1

![Altuve strikes out on a low and inside splitter](swings/altuve_cluster1.gif)

## Cluster 1 Swing Example 2

![Altuve rolls over a high and outside slider](swings/altuve_cluster1v2.gif)

## Cluster 3 Swing Example 1

![Altuve drives a high fastball over the middle of the plate for a home run](swings/altuve_cluster3.gif)

## Cluster 3 Swing Example 2

![Altuve lines a belt-high sinker for a double](swings/altuve_cluster3v2.gif)

:::

As can be seen in the videos, Cluster 1 has a lot of Altuve's more awkward swings. He is more prone to swings and misses, and when he does hit the ball, it is usually weak contact. In the Cluster 3 swings, Altuve is unleashing a much better swing. He is balanced and swinging through the ball, resulting in much stronger contact.
